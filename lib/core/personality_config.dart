...
import 'enums/personalidad_tipo.dart';
...
class PersonalityRegistry {
  static PersonalityConfig? get(String rasgo) {
    final tipo = PersonalidadTipo.fromString(rasgo);
    try {
      return _configs.firstWhere(
        (c) => PersonalidadTipo.fromString(c.rasgo) == tipo,
      );
    } catch (_) {
  ...
  static List<String> get rasgos =>
      PersonalidadTipo.values.map((tipo) => tipo.toDisplayString()).toList();
  ...
  static const List<PersonalityConfig> _configs = [
    ...
    PersonalityConfig(
      ...
      emoji: '⚽',
      descripcion:
          'Le encanta jugar y correr todo el tiempo. Necesita mucha actividad.',
      descripcionIa:
          'Energía cae 2×. Se ensucia 1.5×. Puede tirar comida y juguetes.',
      ...
      reacciones: [
        ...
        StateReaction(
          ...
          misionId: 'jugueton_jugar_urgente',
          generaAlerta: true,
          desastreTipo: 'juguete',
          desastreEmoji: '🎾',
          desastreCantidad: 3,
        ),
      ],
      misiones: [
        PersonalityMission(
          ...
          titulo: '¡A limpiar el desastre de comida!',
          descripcion:
              'Tu mascota tiró comida por todas partes. Toca cada pieza para recogerla.',
          tipo: 'reactiva',
          accionTrigger: 'alimentar',
          condicion: 'alimentarPuedeTirar ocurrió',
          recompensaXp: 30,
          educationalTip:
              'Los animales juguetones necesitan rutinas de alimentación tranquilas.',
          esEspecial: true,
        ),
        PersonalityMission(
          id: 'jugueton_recoger_juguetes',
          titulo: '¡Recoge los juguetes!',
          descripcion:
              'Tu mascota sacó todos los juguetes de la caja. Recógelos tocando cada uno.',
          tipo: 'reactiva',
          accionTrigger: 'jugar',
          condicion: 'mascota agarró otro juguete o estuvo sola',
          recompensaXp: 25,
          educationalTip:
              'Enseñar a recoger juguetes es parte del cuidado responsable.',
          esEspecial: true,
        ),
        PersonalityMission(
          ...
          recompensaXp: 25,
          educationalTip:
              'Los perros juguetones necesitan al menos 30 minutos de actividad al día.',
        ),
      ],
    ),
    ...
    PersonalityConfig(
      ...
      emoji: '😈',
      descripcion:
          'Hace travesuras si lo descuidas. Requiere atención constante.',
      descripcionIa:
          'Deterioro ×8 si descuidado. Se ensucia 2×. Escapa al bañar.',
      acciones: ActionModifiers(
      ...
      misiones: [
        PersonalityMission(
          ...
          titulo: '¡Recoge el desastre de comida!',
          descripcion: 'Tu mascota tiró la comida. Recoge cada pieza.',
          tipo: 'reactiva',
          accionTrigger: 'alimentar',
          condicion: 'siempre al alimentar',
          recompensaXp: 40,
          educationalTip:
              'Los animales traviesos necesitan supervisión al comer.',
          esEspecial: true,
        ),
        PersonalityMission(
          id: 'travieso_recoger_basura',
          titulo: '¡Limpia la basura!',
          descripcion:
              'Tu mascota dejó basura por todas las pantallas. ¡A limpiar!',
          tipo: 'reactiva',
          accionTrigger: 'cualquiera',
          condicion: 'afecto < 25',
          recompensaXp: 35,
          educationalTip:
              'Los animales que se aburren pueden volverse destructivos.',
          esEspecial: true,
        ),
        PersonalityMission(
          id: 'travieso_rutina',
          ...
          recompensaXp: 60,
          educationalTip:
              'Las rutinas ayudan a calmar a los animales traviesos.',
        ),
      ],
    ),
    ...
    PersonalityConfig(
      ...
      emoji: '🍗',
      descripcion:
          'Siempre tiene hambre y come muy rápido. Lento pero constante.',
      descripcionIa:
          'Hambre cae 3×. Plato se vacía 5× más rápido. Hambre solo sube 10% por toma.',
      acciones: ActionModifiers(
      ...
      reacciones: [
        StateReaction(
          nivel: 'hambre',
          umbral: 30,
          estado: 'muy_hambriento',
          mensaje: '¡Tengo MUCHA hambre! ¡Ponme más comida!',
          misionId: 'gloton_alimentar_urgente',
          generaAlerta: true,
        ),
        StateReaction(
          nivel: 'hambre',
          umbral: 15,
          estado: 'hambriento_critico',
          mensaje: '¡No hay nada en mi plato! ¡Me muero de hambre!',
          misionId: 'gloton_alimentar_critico',
          generaAlerta: true,
          desastreTipo: 'comida',
          desastreEmoji: '🍖',
          desastreCantidad: 4,
      ...
      misiones: [
        PersonalityMission(
          id: 'gloton_alimentar_urgente',
          titulo: '¡El glotón tiene hambre!',
          descripcion:
              'Rellena el plato de tu mascota antes de que se quede sin nada.',
          tipo: 'reactiva',
          accionTrigger: 'alimentar',
          condicion: 'hambre < 30',
          recompensaXp: 20,
          educationalTip:
              'Los animales glotones necesitan porciones controladas para no enfermarse.',
          esEspecial: true,
        ),
        PersonalityMission(
          id: 'gloton_ejercicio',
          titulo: '¡A mover el cuerpo!',
          descripcion:
              'Tu mascota glotona necesita ejercicio. ¡Juega con ella!',
          tipo: 'diaria',
          accionTrigger: 'jugar',
          condicion: 'sin jugar en 12h',
          recompensaXp: 30,
          educationalTip:
              'El ejercicio ayuda a los animales a mantenerse sanos aunque coman mucho.',
        ),
      ],
    ),
    ...
    PersonalityConfig(
      ...
      emoji: '🥰',
      descripcion:
          'Busca cariño en todo momento. Solo el juego lo llena de verdad.',
      descripcionIa:
          'Afecto cae 2×. Acciones dan 0.3× afecto. Jugar da 2× afecto.',
      acciones: ActionModifiers(
      ...
      misiones: [
        PersonalityMission(
          id: 'carinoso_jugar',
          titulo: '¡Tu mascota necesita atención!',
          ...
          recompensaXp: 25,
          educationalTip:
              'Los animales cariñosos necesitan tiempo de calidad, no solo comida.',
          esEspecial: true,
        ),
        PersonalityMission(
          id: 'carinoso_constancia',
          titulo: '¡No me olvides!',
          descripcion:
              'Juega con tu mascota al menos una vez al día durante 3 días seguidos.',
          tipo: 'semanal',
          accionTrigger: 'jugar',
          condicion: 'streak_jugar >= 3',
          recompensaXp: 50,
          educationalTip:
              'La constancia es la clave del vínculo con un animal cariñoso.',
        ),
      ],
    ),
    ...
    PersonalityConfig(
      ...
      emoji: '🤒',
      descripcion:
          'Se enferma fácilmente y come muy despacio. Necesita cuidados especiales.',
      descripcionIa:
          'Umbrales de salud más altos. Come lento. Ausencia larga ×2. Misma comida = mal estómago.',
      acciones: ActionModifiers(
      ...
      reacciones: [
        StateReaction(
          nivel: 'salud',
          umbral: 50,
          estado: 'delicado_enfermo',
          mensaje: 'No me siento bien... necesito al veterinario...',
          misionId: 'delicado_curar',
          generaAlerta: true,
        ),
        StateReaction(
          nivel: 'hambre',
          umbral: 35,
          estado: 'delicado_hambriento',
      ...
      misiones: [
        PersonalityMission(
          id: 'delicado_mal_estomago',
          titulo: '¡Mal del estómago!',
          descripcion:
              'Tu mascota comió siempre lo mismo y se enfermó. Recoge las porciones pequeñas que dejó.',
          tipo: 'reactiva',
          accionTrigger: 'alimentar',
          condicion: 'misma comida 3+ veces seguidas',
          recompensaXp: 40,
          educationalTip:
              'Una dieta variada es importante para la salud de los animales delicados.',
          esEspecial: true,
        ),
        PersonalityMission(
          id: 'delicado_veterinario',
          titulo: '¡Visita al veterinario!',
          descripcion: 'Tu mascota delicada necesita revisión médica regular.',
          tipo: 'semanal',
          accionTrigger: 'curar',
          condicion: 'sin curar en 5 días',
          recompensaXp: 45,
          educationalTip:
              'Los animales delicados necesitan visitas veterinarias más frecuentes.',
          esEspecial: true,
        ),
        PersonalityMission(
          id: 'delicado_variedad',
          titulo: '¡Varía su dieta!',
          descripcion: 'Dale un alimento diferente al que le diste ayer.',
          tipo: 'diaria',
          accionTrigger: 'alimentar',
          condicion: 'comida != ultimo_alimento',
          recompensaXp: 20,
          educationalTip:
              'La variedad en la alimentación previene enfermedades digestivas.',
        ),
      ],
    ),
  ]; // fin _configs
